...
| 2026-08-17 | CẦN ĐIỀN | Giảm false alarm | Adaptive và Spatial ensemble | Decision modules | Unit test PASS | FPR/FNR trade-off | Chọn bằng Validation | `d91f6fd` (baseline) |
...
| 2026-08-19 | CẦN ĐIỀN | Chuẩn hóa repository | Tách `src/apps/scripts/data/artifacts`, sửa path và test | Toàn repository | Protocol + 14 Python test + 2 Node test PASS | `.git` vendor và thư mục bị lock | Hash trước cleanup, một Git root | `d91f6fd` |
