...
try:
    ...
    # This single-file upstream implementation still declares Triton kernels
    # below even when Triton is unavailable.  On Windows, use inert decorator
    # and annotation stand-ins: the runtime selects CrossScanF/CrossMergeF
    # whenever WITH_TRITON is false, so these kernels are never executed.
    class _NoTriton:
        @staticmethod
        def jit(function):
            return function
